...
public class PostpaidService extends MobileService implements Operations, Billing{
    ...
    public String toString() 
    {
        ...
        String data= "-----------------------------------------------------------------------------\n"+"Phone number"+"    Call Type       "+"From                   "+"To\n";
//        for(Call c:calls)
//        {
...
//        data= "---------------------------------------------------"
//                + "--------------------------\n"+String.format("%-16s",
//                        "Phone number")+String.format("%-23s","Call Type")+
//                String.format("%-23s","From")+String.format("%-23s", "To")+"\n";
        for(Call c:calls){
          finaldetails=finaldetails+c.toString();
        }
        return super.toString()+"		Connection Date :"+newdate+"\n"
                ...
                discountForReturningCustomer()+"%)	:$"+Math.round(((
                        discountForReturningCustomer()/100.0)*calcBill())*100)
                /100.0+"\n	Final Bill Amount  			:$"+
